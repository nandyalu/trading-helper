...
- A second limit then caps the position at 20% of equity. Risk sizing alone does not bound concentration: a stock with a small ATR produces a large share count from a small risk budget. On a $2,800 account at 1% risk, a $50 stock with a $0.50 ATR sizes to 28 shares — $1,400, half the account — from a $28 risk budget. The cap cuts that to $560.
