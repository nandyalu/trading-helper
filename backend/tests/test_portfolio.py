"""Unit tests for the pure math in backend/services/portfolio.py."""
import pytest

from backend.services import portfolio
from backend.services.portfolio import LotComparison, compare_open_book, concentration_warnings
