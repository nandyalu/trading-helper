"""Unit tests for the pure parts of backend/services/broker.py — position parsing and the
sync reconciliation plan."""
from backend.services.broker import BrokerPosition, _parse_position, plan_sync
