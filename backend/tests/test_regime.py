"""Unit tests for the pure classification/formatting in backend/services/regime.py."""
import datetime

from backend.services.regime import RegimeData, _normalize_yield, classify_regime, format_regime_message
