...
scheduler use. start_discord()/stop_discord() are called from bot/app.py's
...
from bot import analysis, ask, broker, db, digest, notify, paper, portfolio, regime, sizing, watchdog
from bot.positions import compute_position, describe_position
from bot.scorecard import build_scorecard, format_scorecard_embed
