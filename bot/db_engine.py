...
# Same relative-path resolution bot/storage.py uses: lands on /app/data/trading.db
# in the container (the persisted trading_bot_data volume) and data/trading.db
# for local/venv runs.
