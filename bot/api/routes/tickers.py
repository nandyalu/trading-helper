...
transparently inside bot.analysis.run_analysis_and_notify — this route
...
from bot.ask import answer_about_ticker
from bot.positions import compute_position, get_current_price, get_price_history
...
def _real_position(ticker: str) -> PortfolioPositionOut | None:
    """Single-ticker equivalent of bot.portfolio.get_portfolio_positions() —
...
def _paper_position(ticker: str) -> PaperPositionOut | None:
    """Single-ticker equivalent of bot.paper.get_paper_positions() — see
