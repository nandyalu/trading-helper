...
from bot import db
from bot.api.schemas import ActionResultOut, SignalDetailOut, SignalOut
from bot.paper import execute_signal_reaction
...
def get_signal(signal_id: int):
    ...
    return SignalDetailOut(**SignalOut.model_validate(signal).model_dump(), reports=reports)
