"""Market regime snapshot — reuses bot.regime.fetch_regime() directly,
...
from bot.api.schemas import RegimeOut
from bot.regime import classify_regime, fetch_regime
