"""Unit tests for the pure parts of bot/watchdog.py — alert evaluation and
the market-hours gate. Snapshots and positions are constructed in memory."""
import datetime
from zoneinfo import ZoneInfo

from bot.models import Signal
from bot.positions import Position
from bot.watchdog import AlertConfig, DailySnapshot, evaluate_ticker, is_us_market_hours
