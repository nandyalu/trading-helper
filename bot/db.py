"""CRUD operations, all going through bot/db_engine.py's read_session/write_session
...
from bot.db_engine import read_session, write_session
...
# --- Transactions (feed bot/positions.py's compute_position) -----------------
