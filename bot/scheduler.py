...
analysis semaphore/asyncio.to_thread machinery in bot/analysis.py) that
...
from bot import analysis, broker, db, paper, regime, watchdog
from bot.digest import build_weekly_digest_embed
from bot.notify import notify
from bot.positions import PriceWindow, get_price_window
from bot.signals import SignalEvaluation, evaluate_signal_window
...
def register_jobs() -> None:
    ...
    from bot/app.py's lifespan on every startup — quiv's task state is an
